"""
Package depth fusion model for Kaggle upload.
...
Usage:
    python scripts/package_depth_model_kaggle.py
"""
...
def main():
    print("=" * 70)
    print("Packaging Depth Fusion Model for Kaggle")
    print("=" * 70)
    ...
    output_dir = Path('kaggle_upload/depth_fusion_model')
    ...
    print("  2. Upload the contents of kaggle_upload/depth_fusion_model/")
